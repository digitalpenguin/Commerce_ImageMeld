...
if (!createObject('modNamespace',array(
    'name' => 'commerce_imagemeld',
    'path' => $componentPath.'/core/components/commerce_imagemeld/',
    'assets_path' => $componentPath.'/assets/components/commerce_imagemeld/',
),'name', false)) {
    echo "Error creating namespace commerce_imagemeld.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_imagemeld.core_path',
    'value' => $componentPath.'/core/components/commerce_imagemeld/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_imagemeld',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_imagemeld.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_imagemeld.assets_path',
    'value' => $componentPath.'/assets/components/commerce_imagemeld/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_imagemeld',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_imagemeld.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_imagemeld/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_imagemeld.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_imagemeld',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_imagemeld.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_imagemeld.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_imagemeld/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_imagemeld/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'DigitalPenguin\\Commerce_ImageMeld\\Modules\\', $modulePath);
